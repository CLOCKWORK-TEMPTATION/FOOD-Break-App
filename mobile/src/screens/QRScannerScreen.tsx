...
export default QRScannerScreen;
    ...
    try {
      ...
      const response = await fetch('/api/v1/workflow/projects/verify-qr', {
        method: 'POST',
        headers: {
      ...
      if (result.success) {
        ...
        Alert.alert('خطأ', result.error || 'QR Code غير صالح');
        setScanned(false);
      }
    } catch (error) {
      Alert.alert('خطأ', 'فشل في التحقق من QR Code');
      setScanned(false);
    }
  };
  ...
  if (hasPermission === null) {
    return (
      <View style={styles.container}>
        <Text style={styles.text}>جاري طلب إذن الكاميرا...</Text>
      </View>
    );
  }
  ...
  if (hasPermission === false) {
    return (
      <View style={styles.container}>
        <Text style={styles.text}>لا يمكن الوصول للكاميرا</Text>
      </View>
    );
  }
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.overlay}>
        <Text style={styles.title}>مسح QR Code المشروع</Text>
        <Text style={styles.instruction}>
          وجه الكاميرا نحو QR Code الخاص بالمشروع
        </Text>
        ...
        {scanned && (
          <TouchableOpacity
            ...
            onPress={() => setScanned(false)}
          >
            <Text style={styles.scanAgainText}>مسح مرة أخرى</Text>
          </TouchableOpacity>
        )}
      </View>
    </View>
